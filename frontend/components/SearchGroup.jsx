    ...
    return (
        <>
            {visible &&
                <div className="create-post-container">
                    <div className="create-group-form">
                        ...
                        <input type="text" className="search-friends" placeholder="Search" value={searchInput} onChange={(e) => setSearchInput(e.target.value)} />
            ...
            <button type="button" className="search-group-button" onClick={openForm} >
                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.medleague.com%2Fwp-content%2Fuploads%2F2013%2F07%2Fsearching_stick_figure.png&f=1&nofb=1&ipt=138884f890fd1a56eab97a82c56c4c816fbdf15c5c10daf548eb50942258cc4a&ipo=images" />
            </button>
        </>
    )
}
