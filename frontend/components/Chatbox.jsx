                ...
                <div className="chatbox-container">
                    <div className="chatbox-close-container">
                        ...
                        <div className="chat-buttons">
                            {privateChat ? (
                                <>
                                    <button className="leave-group-button" type="button" onClick={leaveChat}>Delete</button>
                                </>
                            ) : (
                                // (admin === user) ? (
                                //     <>
                    ...
                    <form className="message-form" onSubmit={handleMessageSubmit}>
                        <textarea name="message" contentEditable={true} className="message-text-input" value={emoji} onChange={(e) => setEmoji(e.target.value)} placeholder="Write..." />
