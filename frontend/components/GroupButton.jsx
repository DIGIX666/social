                    ...
                    <div className="comment-view">
                        <div className="comment-post-header">
                            ...
                            <div className="edit-members-button-container" style={{ marginTop: '10px' }}>
                                {admin === user &&
                                    <>
                                        <button type="button" className="add-comment-button" onClick={RemoveMembersForm}><i class="fa fa-user-times" aria-hidden="true"></i></button>
                                    </>
                                }
                                <button type="button" className="add-comment-button" onClick={AddMembersForm}><i class="fa fa-user-plus" aria-hidden="true"></i></button>
                                <button type="button" className="add-comment-button" onClick={showEvents}><i class="fa fa-calendar-o" aria-hidden="true"></i></button>
